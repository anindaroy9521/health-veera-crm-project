...
STATE_MACHINE_ARN = (
    'arn:aws:states:us-east-1:168918694591:stateMachine:VeeraHealthStateMachine'
)
...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        ...
        try:
            ...
            print(
                f"Starting Step Function execution "
                f"for file: {source_file_path}"
            )
            ...
            print(
                f"Execution started successfully: "
            ...
            if error_code == 'ExecutionAlreadyExists':
                ...
                print(
                    f"Execution already exists for "
                    f"{source_file_path}"
                )
